...
jacks-own [catch_jack]

bears-own [catch_bear]
...
to setup
  ...
  create_jacks ini_jacks
  create_bears ini_bears
...
to move
  rt random 50
  lt random 50
  ;;face one-of neighbors with [not any? other turtles-here]
  fd 1
end
